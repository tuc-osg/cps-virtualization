...
#[test]
fn test_simultaneous_collisions_different_masses() {
    let name = "simultaneous_collisions_different_masses";
    ...
    let e1 = Entity::new(
        "A",
        State::new(
            Vector3d::new(15.0, 0.0, 0.0) * si::M,
    ...
    let e2 = Entity::new(
        "B",
        State::new(
            Vector3d::new(75.0, 0.0, 0.0) * si::M,
            Vector3d::new(-1.0, 0.0, 0.0) * si::MPS,
            Vector3d::new(0.0, 0.0, 0.0) * si::N,
            50.0 * si::KG,
            Shape::Sphere(Sphere { radius }),
